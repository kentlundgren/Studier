...
- 2026-09-09 (v0.10): Klick-för-större på app-bilderna (JS-lightbox, funkar utan
  JS som vanlig bildlänk). Bildtexterna länkar till claude.com/download resp.
  chatgpt.com/download + Codex-dokumentationen. Prominent länk till
  `jamforelse-roster.md` (GitHub blob) efter röst-skylten; källänkar tillagda i
  skyltens citat och i röst-tabellen i `jamforelse-roster.md` (ny "Källa"-kolumn).
